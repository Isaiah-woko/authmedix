...
const users: MockUser[] = [
  {
    id: "u-doctor", healthId: "LUTH-DOC-0231", email: "doctor@meditrust.dev", password: "Passw0rd!Doc",
    name: "Dr. Amina Bello", role: "DOCTOR", hospitalId: "LUTH",
    mustChangePassword: true, status: "ACTIVE", failedLogins: 0, locked: false,
  },
  {
    id: "u-nurse", healthId: "LUTH-NUR-0112", email: "nurse@meditrust.dev", password: "Passw0rd!Nur",
    name: "Musa Okafor, RN", role: "NURSE", hospitalId: "LUTH",
    mustChangePassword: false, status: "ACTIVE", failedLogins: 0, locked: false,
  },
  {
    id: "u-pharmacist", healthId: "LUTH-PHA-0045", email: "pharmacist@meditrust.dev", password: "Passw0rd!Pha",
    name: "Grace Adeyemi", role: "PHARMACIST", hospitalId: "LUTH",
    mustChangePassword: false, status: "ACTIVE", failedLogins: 0, locked: false,
  },
  {
    id: "u-lab", healthId: "LUTH-LAB-0091", email: "lab@meditrust.dev", password: "Passw0rd!Lab",
    name: "Blessing Okoro", role: "LAB", hospitalId: "LUTH",
    mustChangePassword: false, status: "ACTIVE", failedLogins: 0, locked: false,
  },
  {
    id: "u-admin", healthId: "LUTH-ADM-0007", email: "admin@meditrust.dev", password: "Passw0rd!Adm",
    name: "Chidi Balogun", role: "ADMIN", hospitalId: "LUTH",
    mustChangePassword: false, status: "ACTIVE", failedLogins: 0, locked: false,
  },
];
...
const passports: MockPassport[] = [
  {
    id: "pas-1", type: "STANDARD", status: "ACTIVE", userId: "LUTH-DOC-0231", patientId: "pt-1",
    purpose: "Clinical consultation and treatment", scope: "Notes, Labs, Prescriptions, Uploads, Allergies",
    duration: "8H", expiresAt: hoursFromNow(2.23), createdAt: hoursFromNow(-5.77),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
  {
    id: "pas-2", type: "REFERRAL", status: "ACTIVE", userId: "LUTH-DOC-0231", patientId: "pt-2",
    purpose: "Inter-hospital referral", scope: "Notes, Labs, Prescriptions, Uploads, Allergies",
    duration: "48H", expiresAt: hoursFromNow(0.47), createdAt: hoursFromNow(-47.5),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
  {
    id: "pas-3", type: "BREAK_GLASS", status: "ACTIVE", userId: "LUTH-DOC-0231", patientId: "pt-3",
    purpose: "Emergency access", scope: "Emergency Summary",
    duration: "2H", expiresAt: hoursFromNow(0.68), createdAt: hoursFromNow(-1.32),
    grantedById: null, renewalCount: 0, flagged: true, reviewed: false,
    reasonCategory: "UNCONSCIOUS_UNRESPONSIVE",
    reasonDetail: "Patient unconscious following suspected poisoning. Immediate access to medication and allergy history required.",
  },
  {
    id: "pas-4", type: "STANDARD", status: "EXPIRED", userId: "LUTH-DOC-0231", patientId: "pt-5",
    purpose: "Prior episode of care", scope: "Notes, Labs",
    duration: "8H", expiresAt: hoursFromNow(-3), createdAt: hoursFromNow(-11),
    grantedById: "LUTH-ADM-0007", renewalCount: 1, flagged: false,
  },
  {
    id: "pas-5", type: "STANDARD", status: "REVOKED", userId: "LUTH-DOC-0231", patientId: "pt-6",
    purpose: "Ward cover", scope: "Notes",
    duration: "8H", expiresAt: hoursFromNow(5), createdAt: hoursFromNow(-2),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
  {
    id: "pas-6", type: "STANDARD", status: "ACTIVE", userId: "LUTH-NUR-0112", patientId: "pt-1",
    purpose: "Patient care and monitoring", scope: "Notes, Labs, Uploads, Allergies",
    duration: "8H", expiresAt: hoursFromNow(4), createdAt: hoursFromNow(-4),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
  {
    id: "pas-7", type: "STANDARD", status: "ACTIVE", userId: "LUTH-LAB-0091", patientId: "pt-1",
    purpose: "Laboratory investigation", scope: "Labs",
    duration: "8H", expiresAt: hoursFromNow(6), createdAt: hoursFromNow(-2),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
  {
    id: "pas-8", type: "STANDARD", status: "ACTIVE", userId: "LUTH-PHA-0045", patientId: "pt-6",
    purpose: "Medication review and dispensing", scope: "Prescriptions, Allergies",
    duration: "8H", expiresAt: hoursFromNow(5), createdAt: hoursFromNow(-3),
    grantedById: "LUTH-ADM-0007", renewalCount: 0, flagged: false,
  },
];
...
const passportRequests = [
  {
    id: "req-1", userId: "LUTH-DOC-0231", patientId: "pt-4",
    purpose: "Clinical consultation and treatment",
    scope: "Notes, Labs, Prescriptions, Uploads, Allergies",
    status: "PENDING" as const, createdAt: hoursFromNow(-1),
  },
];

/** Which record types each role may see under a STANDARD or REFERRAL passport. */
...
export async function mockRequest<T>(
  ...
  // POST /auth/resend-code (contract gap, confirm with tech lead)
  ...
  // GET /patients?query= (identity only, never reveals access status)
  if (method === "GET" && path === "/patients") {
    ...
    return patients
      .filter(
        (p) => p.name.toLowerCase().includes(q) || p.patientCode.toLowerCase().includes(q)
      )
      .map(identityOf) as T;
  }
  ...
  // GET /passport-requests (mine, or pending for Admin)
