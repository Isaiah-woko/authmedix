...
export async function sendOtpEmail(to: string, code: string) {
  ...
  try {
    await transporter.sendMail({
      ...
      to,
      subject: 'Your AuthMedix Verification Code',
      text: `Your AuthMedix verification code is: ${code}`,
      html: `
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; padding: 20px; color: #161B22;">
          <h2 style="color: #2B3A67; margin-bottom: 10px;">AuthMedix Verification</h2>
